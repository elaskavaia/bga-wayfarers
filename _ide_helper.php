...
namespace Bga\GameFramework\Actions {
    ...
    #[\Attribute]
    class Debug {
        public function __construct(public bool $reload = false) {}
    }
}
...
namespace Bga\GameFramework\Actions\Types {
    #[\Attribute]
    class IntParam {
        public function __construct(?string $name = null, public ?int $min = null, public ?int $max = null) {}
    ...
    #[\Attribute]
    class FloatParam {
        public function __construct(?string $name = null, public ?float $min = null, public ?float $max = null) {}
...
namespace Bga\GameFramework {
    ...
    abstract class GamestateMachine {
         ...
         * @param string|int|class-string<\Bga\GameFramework\States\GameState> $nextState the transition name, or state id, or class name if using Class states
        ...
        final public function state(
            bool $bSkipStateArgs = false,
            bool $bOnlyVariableContent = false,
            bool $bSkipReflexionTimeLoad = false
        ): array {
            return [];
        }
         ...
         *
         * @param string|int|class-string<\Bga\GameFramework\States\GameState> $nextStateIfNone the transition name, or state id, or class name if using Class states
         * @return void
         */
    ...
    abstract class Table {
        /** Stat definitions parsed from stats.jsonc (keyed "player" / "table"). */
        public function getStatTypes(): array {}

        /** Game option definitions parsed from gameoptions.jsonc. */
         ...
         */
        public readonly \Bga\GameFramework\Bga $bga;
         ...
         */
        public readonly \Bga\GameFramework\Debug $debug;
         ...
         */
        final public function getActivePlayerId(): string {
            /*|int*/
            return "0";
        }
         ...
         */
        final public function notifyPlayer(
            int $playerId,
...
namespace Bga\GameFramework\GameResult {
    ...
    class GameResult {
         ...
         * @return self
         */
        public static function individualRanking(array $players, bool $reverseScore = false, bool $reverseScoreAux = false) {
            return new self();
        }
...
namespace {
    ...
    abstract class APP_GameAction {
         ...
         */
        final protected function getArg(
            string $argName,
            int $argType,
            bool $bMandatory = false,
            mixed $default = null,
            array $argTypeDetails = [],
            bool $bCanFail = false
        ): mixed {
            return null;
        }
