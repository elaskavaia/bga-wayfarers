...
// # 115|2|food:2coin|Observatory|Wanderer||Pay Provisions: Gain 2 Silver
    ...
    "card_folk_139" => [ 
        ...
        "tooltip" => clienttranslate("Place Influence on Blue Guild or Move Influence"),
],
    "card_folk_140" => [ 
        "create" => 1,
        "num" => 140,
        ...
        "tags" => "City Harbour",
        "nom" => clienttranslate("Scholar"),
        "tooltip" => clienttranslate("Place Influence on Yellow Guild or Move Influence"),
],
    "card_folk_141" => [ 
        "create" => 1,
        "num" => 141,
        ...
        "tags" => "Book Observatory",
        "nom" => clienttranslate("Scholar"),
        "tooltip" => clienttranslate("Place Influence on Black Guild or Move Influence"),
],
    "card_folk_142" => [ 
        "create" => 1,
        "num" => 142,
...
// # Row 1-3: City (1-18)
    "card_land_1" => [ 
        ...
        "todr" => clienttranslate("Gain a Land Upgrade Tile or place 2 Influence on Yellow Guild"),
],
    "card_land_2" => [ 
        "create" => 1,
        "num" => 2,
    ...
    "card_land_6" => [ 
        ...
        "tags" => "City",
        "tor" => clienttranslate("Place Influence on Yellow Guild"),
        "todr" => clienttranslate("Pay 2 Provisions to acquire a Land card and place Influence on Yellow Guild"),
],
    "card_land_7" => [ 
        "create" => 1,
        "num" => 7,
        ...
        "todr" => clienttranslate("Acquire a Townsfolk card and place Influence on Blue Guild"),
],
    "card_land_8" => [ 
        "create" => 1,
        "num" => 8,
    ...
    "card_land_10" => [ 
        ...
        "tags" => "City Observatory",
        "todr" => clienttranslate("Acquire a Space card and place Influence on Yellow Guild"),
],
    "card_land_11" => [ 
        "create" => 1,
        "num" => 11,
        ...
        "tags" => "City Observatory",
        "todr" => clienttranslate("Gain a Space Upgrade Tile or place 2 Influence on Black Guild"),
],
    "card_land_12" => [ 
        "create" => 1,
        "num" => 12,
    ...
    "card_land_13" => [ 
        ...
        "tags" => "City Observatory",
        "todr" => clienttranslate("Acquire a Space card and place Influence on Black Guild"),
],
    "card_land_14" => [ 
        "create" => 1,
        "num" => 14,
    ...
    "card_land_16" => [ 
        ...
        "tags" => "City Book",
        "todr" => clienttranslate("Place Influence on Yellow Guild and Journal"),
],
    "card_land_17" => [ 
        "create" => 1,
        "num" => 17,
        ...
        "dr" => "infBlue,journal",
        "tags" => "City Book",
        "todr" => clienttranslate("Place Influence on Blue Guild and Journal"),
],
    "card_land_18" => [ 
        "create" => 1,
        "num" => 18,
        ...
        "todr" => clienttranslate("Place Influence on Black Guild and Journal"),
],
// # Row 4-6: Vista (19-37)
    "card_land_19" => [ 
        "create" => 1,
        ...
        "tags" => "Vista",
        "trig" => "Stars",
        "tor" => clienttranslate("Place 2 Influence on Cards"),
    ...
    "card_land_22" => [ 
        ...
        "trig" => "Sea",
        "tor" => clienttranslate("Place Influence on Blue Guild"),
        "todr" => clienttranslate("Place Influence on Blue Guild or Move Influence"),
],
    "card_land_23" => [ 
        "create" => 1,
        "num" => 23,
    ...
    "card_land_30" => [ 
        ...
        "trig" => "City",
        "tor" => clienttranslate("Refresh a die"),
        "todr" => clienttranslate("Place Influence on Yellow Guild or Move Influence"),
],
    "card_land_31" => [ 
        "create" => 1,
        "num" => 31,
...
// # 40|cardLand(draw1)|||Sea|___|___x|Draw and acquire 1 Land card|
    ...
    "card_water_47" => [ 
        ...
        "c1" => "xx__",
        "c2" => "u_x_",
        "todr" => clienttranslate("Gain a Water Upgrade Tile or place 2 Influence on Blue Guild"),
],
    "card_water_48" => [ 
        "create" => 1,
        "num" => 48,
    ...
    "card_water_59" => [ 
        ...
        "c1" => "_x__",
        "c2" => "bxxx",
        "tor" => clienttranslate("Place Influence on Black Guild, gain Silver and Provisions, and place Influence on a Card"),
],
    "card_water_60" => [ 
        "create" => 1,
        "num" => 60,
    ...
    "card_water_69" => [ 
        ...
        "c1" => "_x__",
        "c2" => "_x_x",
        "tor" => clienttranslate("Place Influence on Black Guild and Journal"),
],
    "card_water_70" => [ 
        "create" => 1,
        "num" => 70,
    ...
    "card_water_74" => [ 
        ...
        "c1" => "__x_",
        "c2" => "yx_x",
        "tor" => clienttranslate("Place 2 Influence on Blue Guild"),
],
    "card_water_75" => [ 
        "create" => 1,
        "num" => 75,
        ...
        "c1" => "_x__",
        "c2" => "u_xx",
        "tor" => clienttranslate("Place 2 Influence on Yellow Guild"),
],
    "card_water_76" => [ 
        "create" => 1,
        "num" => 76,
        ...
        "c1" => "___x",
        "c2" => "_xx_",
        "tor" => clienttranslate("Place 2 Influence on Black Guild"),
],
...
// #Journal tiles
    ...
    "jtile_2" => [ 
        "num" => 2,
        "r" => "infYellow,infYellow",
        "tooltip" => clienttranslate("Place 2 Influence on Yellow Guild"),
],
    "jtile_3" => [ 
        "num" => 3,
        "r" => "infBlue,infBlue",
        "tooltip" => clienttranslate("Place 2 Influence on Blue Guild"),
],
    "jtile_4" => [ 
        "num" => 4,
        "r" => "cardFolk(free)",
        "tooltip" => clienttranslate("Acquire a free Townsfolk card"),
],
    "jtile_5" => [ 
        "num" => 5,
        "r" => "food,coin",
    ...
    "jtile_10" => [ 
        "num" => 10,
        "r" => "infYellow,infBlue",
        "tooltip" => clienttranslate("Place Influence on Yellow and Blue Guild"),
],
