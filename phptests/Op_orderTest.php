...
final class Op_orderTest extends TestCase {
    ...
    public function testAutoDoesNotResolve_MixedTrivialAndNonTrivial(): void {
        ...
        $op = $this->game->machine->instantiateOperation("cardFolk+coin", PCOLOR);
        $result = $op->auto();
    ...
    public function testAutoDoesNotResolve_MultipleNonTrivial(): void {
        ...
        $op = $this->game->machine->instantiateOperation("infMove+cardFolk", PCOLOR);
        $result = $op->auto();
    ...
    public function testAutoResolves_ZeroDelegates(): void {
        ...
        /** @var Op_order */
        $op = $this->game->machine->instantiateOperation("order", PCOLOR);
        $result = $op->auto();
    ...
    public function testAutoDoesNotResolve_MixedMultiple(): void {
        ...
        $op = $this->game->machine->instantiateOperation("coin+infMove+food+cardFolk", PCOLOR);
        $result = $op->auto();
    ...
    public function testAutoResolves_SingleSeqDelegate(): void {
        ...
        /** @var Op_order */
        $op = $this->game->machine->instantiateOperation("order", PCOLOR);
        $op->withDelegate($this->game->machine->instantiateOperation("coin,food", PCOLOR));
        $op->saveToDb(1, true);
